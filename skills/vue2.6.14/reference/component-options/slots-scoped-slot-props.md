...
> **Note**: `slot-scope` was introduced in Vue 2.5.0. In Vue 2.6.0+, `v-slot` is the recommended syntax, but `slot-scope` is still supported.

```vue
<!-- Old slot-scope syntax (Vue 2.5.x) -->
<template>
  <UserList :users="users">
